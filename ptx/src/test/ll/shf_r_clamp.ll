define amdgpu_kernel void @shf_r_clamp(ptr addrspace(4) byref(i64) %"46", ptr addrspace(4) byref(i64) %"47") #0 {
...
"45":                                             ; preds = %1
  ...
  %13 = call i32 @llvm.fshr.i32(i32 %11, i32 %10, i32 %12)
  %14 = icmp uge i32 %12, 32
  %"71" = select i1 %14, i32 %11, i32 %13
