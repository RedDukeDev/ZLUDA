define amdgpu_kernel void @setp(ptr addrspace(4) byref(i64) %"50", ptr addrspace(4) byref(i64) %"51") #0 {
...
"20":                                             ; preds = %"19", %"49"
  %12 = load i1, ptr addrspace(5) %"57", align 1
...
"22":                                             ; preds = %"21", %"20"
  %13 = load i64, ptr addrspace(5) %"53", align 8
