define amdgpu_kernel void @cvt_rn_satfinite_e5m2x2_f32(ptr addrspace(4) byref(i64) %"43", ptr addrspace(4) byref(i64) %"44") #0 {
...
"42":                                             ; preds = %1
  ...
  %23 = and i32 %20, 2097151
  %24 = lshr i32 %20, 21
  %25 = icmp ugt i32 %23, 1048576
  %26 = icmp eq i32 %23, 1048576
  %27 = and i32 %24, 1
  %28 = icmp ne i32 %27, 0
  %29 = and i1 %26, %28
  %30 = or i1 %25, %29
  ...
  %36 = add i32 %22, %35
  %37 = add i32 %36, 15
  %38 = icmp uge i32 %37, 31
  %39 = sub i32 %34, 4
  %40 = shl i32 %37, 2
  %41 = or i32 %40, %39
  %42 = select i1 %38, i32 123, i32 %41
  %43 = sub i32 7, %22
  ...
  %81 = and i32 %78, 2097151
  %82 = lshr i32 %78, 21
  %83 = icmp ugt i32 %81, 1048576
  %84 = icmp eq i32 %81, 1048576
  %85 = and i32 %82, 1
  %86 = icmp ne i32 %85, 0
  %87 = and i1 %84, %86
  %88 = or i1 %83, %87
  ...
  %94 = add i32 %80, %93
  %95 = add i32 %94, 15
  %96 = icmp uge i32 %95, 31
  %97 = sub i32 %92, 4
  %98 = shl i32 %95, 2
  %99 = or i32 %98, %97
  %100 = select i1 %96, i32 123, i32 %99
  %101 = sub i32 7, %80
  ...
  %120 = select i1 %119, i32 3, i32 %118
  %121 = icmp sge i32 %80, -14
