...
define amdgpu_kernel void @cvt_rn_f16x2_e4m3x2(ptr addrspace(4) byref(i64) %"40", ptr addrspace(4) byref(i64) %"41") #1 {
...
"39":                                             ; preds = %1
  ...
  %"58" = call i32 @__zluda_ptx_impl_cvt_rn_f16x2_e4m3x2(i16 %6)
