define amdgpu_kernel void @mul24_lo_s32(ptr addrspace(4) byref(i64) %"41", ptr addrspace(4) byref(i64) %"42") #0 {
...
"40":                                             ; preds = %1
  ...
  %"54" = call i32 @llvm.amdgcn.mul.i24.i32(i32 %7, i32 %8)
...
declare i32 @llvm.amdgcn.mul.i24.i32(i32, i32) #2
