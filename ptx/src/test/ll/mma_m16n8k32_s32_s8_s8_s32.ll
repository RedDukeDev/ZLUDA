...
"117":                                            ; preds = %1
  ...
  %"131" = zext i16 %"77" to i32
  store i32 %"131", ptr addrspace(5) %"127", align 4
  %"78" = extractelement <4 x i16> %"12", i8 1
  %"132" = zext i16 %"78" to i32
  store i32 %"132", ptr addrspace(5) %"128", align 4
  %"79" = extractelement <4 x i16> %"12", i8 2
  %"133" = zext i16 %"79" to i32
  store i32 %"133", ptr addrspace(5) %"129", align 4
  %"80" = extractelement <4 x i16> %"12", i8 3
  %"134" = zext i16 %"80" to i32
  store i32 %"134", ptr addrspace(5) %"130", align 4
  %2 = load i32, ptr addrspace(5) %"128", align 4
  %3 = shl i32 %2, 8
  %"302" = select i1 false, i32 0, i32 %3
  store i32 %"302", ptr addrspace(5) %"128", align 4
  %4 = load i32, ptr addrspace(5) %"129", align 4
  %5 = shl i32 %4, 16
  %"304" = select i1 false, i32 0, i32 %5
  store i32 %"304", ptr addrspace(5) %"129", align 4
  %6 = load i32, ptr addrspace(5) %"130", align 4
  %7 = shl i32 %6, 24
  %"306" = select i1 false, i32 0, i32 %7
  store i32 %"306", ptr addrspace(5) %"130", align 4
  %8 = load i32, ptr addrspace(5) %"127", align 4
  store i32 %8, ptr addrspace(5) %"126", align 4
  %9 = load i32, ptr addrspace(5) %"126", align 4
  %10 = load i32, ptr addrspace(5) %"128", align 4
  %"310" = or i32 %9, %10
  store i32 %"310", ptr addrspace(5) %"126", align 4
  %11 = load i32, ptr addrspace(5) %"126", align 4
  %12 = load i32, ptr addrspace(5) %"129", align 4
  %"313" = or i32 %11, %12
  store i32 %"313", ptr addrspace(5) %"126", align 4
  %13 = load i32, ptr addrspace(5) %"126", align 4
  %14 = load i32, ptr addrspace(5) %"130", align 4
  %"316" = or i32 %13, %14
...
define amdgpu_kernel void @mma_m16n8k32_s32_s8_s8_s32(ptr addrspace(4) byref(i64) %"152") #2 {
...
"118":                                            ; preds = %1
  ...
  store i16 %"188", ptr addrspace(5) %"156", align 2
  %4 = load i16, ptr addrspace(5) %"156", align 2
  %"190" = mul i16 %4, 16
  ...
  %21 = load i16, ptr addrspace(5) %"157", align 2
  %22 = load i16, ptr addrspace(5) %"158", align 2
  %23 = load i16, ptr addrspace(5) %"159", align 2
  %24 = insertelement <4 x i16> undef, i16 %20, i8 0
  %25 = insertelement <4 x i16> %24, i16 %21, i8 1
  %26 = insertelement <4 x i16> %25, i16 %22, i8 2
  %"100" = insertelement <4 x i16> %26, i16 %23, i8 3
  store <4 x i16> %"100", ptr addrspace(5) %"222", align 8
  %27 = load <4 x i16>, ptr addrspace(5) %"222", align 8
  %"319" = call i32 @pack_u8(<4 x i16> %27)
  store i32 %"319", ptr addrspace(5) %"176", align 4
  br label %"119"

"119":                                            ; preds = %"118"
  %28 = load i16, ptr addrspace(5) %"160", align 2
  %29 = load i16, ptr addrspace(5) %"161", align 2
  %30 = load i16, ptr addrspace(5) %"162", align 2
  %31 = load i16, ptr addrspace(5) %"163", align 2
  %32 = insertelement <4 x i16> undef, i16 %28, i8 0
  %33 = insertelement <4 x i16> %32, i16 %29, i8 1
  %34 = insertelement <4 x i16> %33, i16 %30, i8 2
  %"101" = insertelement <4 x i16> %34, i16 %31, i8 3
  store <4 x i16> %"101", ptr addrspace(5) %"222", align 8
  %35 = load <4 x i16>, ptr addrspace(5) %"222", align 8
  %"320" = call i32 @pack_u8(<4 x i16> %35)
  store i32 %"320", ptr addrspace(5) %"177", align 4
  br label %"120"

"120":                                            ; preds = %"119"
  %36 = load i16, ptr addrspace(5) %"164", align 2
  %37 = load i16, ptr addrspace(5) %"165", align 2
  %38 = load i16, ptr addrspace(5) %"166", align 2
  %39 = load i16, ptr addrspace(5) %"167", align 2
  %40 = insertelement <4 x i16> undef, i16 %36, i8 0
  %41 = insertelement <4 x i16> %40, i16 %37, i8 1
  %42 = insertelement <4 x i16> %41, i16 %38, i8 2
  %"102" = insertelement <4 x i16> %42, i16 %39, i8 3
  store <4 x i16> %"102", ptr addrspace(5) %"222", align 8
  %43 = load <4 x i16>, ptr addrspace(5) %"222", align 8
  %"321" = call i32 @pack_u8(<4 x i16> %43)
  store i32 %"321", ptr addrspace(5) %"178", align 4
  br label %"121"

"121":                                            ; preds = %"120"
  %44 = load i16, ptr addrspace(5) %"168", align 2
  %45 = load i16, ptr addrspace(5) %"169", align 2
  %46 = load i16, ptr addrspace(5) %"170", align 2
  %47 = load i16, ptr addrspace(5) %"171", align 2
  %48 = insertelement <4 x i16> undef, i16 %44, i8 0
  %49 = insertelement <4 x i16> %48, i16 %45, i8 1
  %50 = insertelement <4 x i16> %49, i16 %46, i8 2
  %"103" = insertelement <4 x i16> %50, i16 %47, i8 3
  store <4 x i16> %"103", ptr addrspace(5) %"222", align 8
  %51 = load <4 x i16>, ptr addrspace(5) %"222", align 8
  %"322" = call i32 @pack_u8(<4 x i16> %51)
  store i32 %"322", ptr addrspace(5) %"179", align 4
  br label %"122"

"122":                                            ; preds = %"121"
  %52 = load i16, ptr addrspace(5) %"156", align 2
  %53 = load i16, ptr addrspace(5) %"157", align 2
  %54 = load i16, ptr addrspace(5) %"158", align 2
  %55 = load i16, ptr addrspace(5) %"159", align 2
  %56 = insertelement <4 x i16> undef, i16 %52, i8 0
  %57 = insertelement <4 x i16> %56, i16 %53, i8 1
  %58 = insertelement <4 x i16> %57, i16 %54, i8 2
  %"104" = insertelement <4 x i16> %58, i16 %55, i8 3
  store <4 x i16> %"104", ptr addrspace(5) %"222", align 8
  %59 = load <4 x i16>, ptr addrspace(5) %"222", align 8
  %"323" = call i32 @pack_u8(<4 x i16> %59)
  store i32 %"323", ptr addrspace(5) %"180", align 4
  br label %"123"

"123":                                            ; preds = %"122"
  %60 = load i16, ptr addrspace(5) %"156", align 2
  %61 = load i16, ptr addrspace(5) %"157", align 2
  %62 = load i16, ptr addrspace(5) %"158", align 2
  %63 = load i16, ptr addrspace(5) %"159", align 2
  %64 = insertelement <4 x i16> undef, i16 %60, i8 0
  %65 = insertelement <4 x i16> %64, i16 %61, i8 1
  %66 = insertelement <4 x i16> %65, i16 %62, i8 2
  %"105" = insertelement <4 x i16> %66, i16 %63, i8 3
  store <4 x i16> %"105", ptr addrspace(5) %"222", align 8
  %67 = load <4 x i16>, ptr addrspace(5) %"222", align 8
  %"324" = call i32 @pack_u8(<4 x i16> %67)
  store i32 %"324", ptr addrspace(5) %"181", align 4
  br label %"124"

"124":                                            ; preds = %"123"
  %68 = load i16, ptr addrspace(5) %"156", align 2
  %"265" = zext i16 %68 to i32
  store i32 %"265", ptr addrspace(5) %"172", align 4
  %69 = load i16, ptr addrspace(5) %"157", align 2
  %"267" = zext i16 %69 to i32
  store i32 %"267", ptr addrspace(5) %"173", align 4
  %70 = load i16, ptr addrspace(5) %"158", align 2
  %"269" = zext i16 %70 to i32
  store i32 %"269", ptr addrspace(5) %"174", align 4
  %71 = load i16, ptr addrspace(5) %"159", align 2
  %"271" = zext i16 %71 to i32
  store i32 %"271", ptr addrspace(5) %"175", align 4
  %72 = load i32, ptr addrspace(5) %"176", align 4
  %73 = load i32, ptr addrspace(5) %"177", align 4
  %74 = load i32, ptr addrspace(5) %"178", align 4
  %75 = load i32, ptr addrspace(5) %"179", align 4
  %76 = insertelement <4 x i32> undef, i32 %72, i8 0
  %77 = insertelement <4 x i32> %76, i32 %73, i8 1
  %78 = insertelement <4 x i32> %77, i32 %74, i8 2
  %"107" = insertelement <4 x i32> %78, i32 %75, i8 3
  %79 = load i32, ptr addrspace(5) %"180", align 4
  %80 = load i32, ptr addrspace(5) %"181", align 4
  %81 = insertelement <2 x i32> undef, i32 %79, i8 0
  %"108" = insertelement <2 x i32> %81, i32 %80, i8 1
  %82 = load i32, ptr addrspace(5) %"172", align 4
  %83 = load i32, ptr addrspace(5) %"173", align 4
  %84 = load i32, ptr addrspace(5) %"174", align 4
  %85 = load i32, ptr addrspace(5) %"175", align 4
  %86 = insertelement <4 x i32> undef, i32 %82, i8 0
  %87 = insertelement <4 x i32> %86, i32 %83, i8 1
  %88 = insertelement <4 x i32> %87, i32 %84, i8 2
  %"109" = insertelement <4 x i32> %88, i32 %85, i8 3
  ...
  %89 = load i32, ptr addrspace(5) %"155", align 4
  %"287" = zext i32 %89 to i64
  store i64 %"287", ptr addrspace(5) %"154", align 8
  %90 = load i64, ptr addrspace(5) %"154", align 8
  %"289" = mul i64 %90, 16
  store i64 %"289", ptr addrspace(5) %"154", align 8
  %91 = load i64, ptr addrspace(5) %"153", align 8
  %92 = load i64, ptr addrspace(5) %"154", align 8
  %"291" = add i64 %91, %92
  store i64 %"291", ptr addrspace(5) %"153", align 8
  %93 = load i64, ptr addrspace(5) %"153", align 8
  %94 = load i32, ptr addrspace(5) %"182", align 4
  %"335" = inttoptr i64 %93 to ptr
  %"336" = bitcast i32 %94 to float
  store float %"336", ptr %"335", align 4
  %95 = load i64, ptr addrspace(5) %"153", align 8
  %"337" = inttoptr i64 %95 to ptr
  %"112" = getelementptr inbounds i8, ptr %"337", i64 4
  %96 = load i32, ptr addrspace(5) %"183", align 4
  %"338" = bitcast i32 %96 to float
  store float %"338", ptr %"112", align 4
  %97 = load i64, ptr addrspace(5) %"153", align 8
  %"339" = inttoptr i64 %97 to ptr
  %"114" = getelementptr inbounds i8, ptr %"339", i64 8
  %98 = load i32, ptr addrspace(5) %"184", align 4
  %"340" = bitcast i32 %98 to float
  store float %"340", ptr %"114", align 4
  %99 = load i64, ptr addrspace(5) %"153", align 8
  %"341" = inttoptr i64 %99 to ptr
  %"116" = getelementptr inbounds i8, ptr %"341", i64 12
  %100 = load i32, ptr addrspace(5) %"185", align 4
  %"342" = bitcast i32 %100 to float
