...
define amdgpu_kernel void @cvt_rn_satfinite_e4m3x2_f32(ptr addrspace(4) byref(i64) %"43", ptr addrspace(4) byref(i64) %"44") #1 {
...
"42":                                             ; preds = %1
  ...
  %"63" = call i16 @__zluda_ptx_impl_cvt_rn_satfinite_e4m3x2_f32(float %8, float %9)
  store i16 %"63", ptr addrspace(5) %"49", align 2
  %10 = load i64, ptr addrspace(5) %"46", align 8
  %11 = load i16, ptr addrspace(5) %"49", align 2
  %"64" = inttoptr i64 %10 to ptr
  store i16 %11, ptr %"64", align 2
  ret void
}
