...
define amdgpu_kernel void @shfl_sync_bfly_b32_pred(ptr addrspace(4) byref(i64) %"50") #1 {
...
"48":                                             ; preds = %1
  ...
  %"76" = call <2 x i32> @__zluda_ptx_impl_shfl_sync_bfly_b32_pred(i32 %3, i32 3, i32 31, i32 -1)
