define amdgpu_kernel void @setp_nan(ptr addrspace(4) byref(i64) %"92", ptr addrspace(4) byref(i64) %"93") #0 {
...
"25":                                             ; preds = %"91"
  store i32 1, ptr addrspace(5) %"104", align 4
  br label %"26"
