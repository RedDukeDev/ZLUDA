define amdgpu_kernel void @fma_bf16x2(ptr addrspace(4) byref(i64) %"45", ptr addrspace(4) byref(i64) %"46") #0 {
...
"44":                                             ; preds = %1
  ...
  %"70" = bitcast i32 %10 to <2 x bfloat>
  %"71" = bitcast i32 %11 to <2 x bfloat>
  %"72" = bitcast i32 %12 to <2 x bfloat>
  %"69" = call <2 x bfloat> @llvm.fma.v2bf16(<2 x bfloat> %"70", <2 x bfloat> %"71", <2 x bfloat> %"72")
  %"60" = bitcast <2 x bfloat> %"69" to i32
...
declare <2 x bfloat> @llvm.fma.v2bf16(<2 x bfloat>, <2 x bfloat>, <2 x bfloat>) #2
