...
define amdgpu_kernel void @prmt_signext(ptr addrspace(4) byref(i64) %"44", ptr addrspace(4) byref(i64) %"45") #1 {
...
"43":                                             ; preds = %1
  ...
  %"64" = call i32 @__zluda_ptx_impl_prmt_b32(i32 %8, i32 %9, i32 2568)
  store i32 %"64", ptr addrspace(5) %"50", align 4
  %10 = load i64, ptr addrspace(5) %"47", align 8
  %11 = load i32, ptr addrspace(5) %"50", align 4
  %"67" = inttoptr i64 %10 to ptr
