define amdgpu_kernel void @sign_extend(ptr addrspace(4) byref(i64) %"39", ptr addrspace(4) byref(i64) %"40") #0 {
...
"38":                                             ; preds = %1
  ...
  %"46" = sext i16 %5 to i32
  store i32 %"46", ptr addrspace(5) %"43", align 4
