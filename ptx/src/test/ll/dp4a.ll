define amdgpu_kernel void @dp4a(ptr addrspace(4) byref(i64) %"46", ptr addrspace(4) byref(i64) %"47") #0 {
...
declare i32 @llvm.amdgcn.sdot4(i32, i32, i32, i1 immarg) #2
