...
define amdgpu_kernel void @prmt_slow(ptr addrspace(4) byref(i64) %"45", ptr addrspace(4) byref(i64) %"46") #1 {
...
"44":                                             ; preds = %1
  ...
  %"69" = call i32 @__zluda_ptx_impl_prmt_b32(i32 %10, i32 %11, i32 %12)
  store i32 %"69", ptr addrspace(5) %"50", align 4
  %13 = load i64, ptr addrspace(5) %"48", align 8
  %14 = load i32, ptr addrspace(5) %"50", align 4
