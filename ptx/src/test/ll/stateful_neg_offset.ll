...
"41":                                             ; preds = %1
  ...
  %"66" = ptrtoint ptr addrspace(1) %6 to i64
  store i64 %"66", ptr addrspace(5) %"46", align 8
  %7 = load i64, ptr addrspace(5) %"45", align 8
  %8 = inttoptr i64 %7 to ptr
  %9 = addrspacecast ptr %8 to ptr addrspace(1)
  %"68" = ptrtoint ptr addrspace(1) %9 to i64
  store i64 %"68", ptr addrspace(5) %"47", align 8
  ...
  %"70" = inttoptr i64 %14 to ptr addrspace(1)
  %15 = load i64, ptr addrspace(1) %"70", align 8
  store i64 %15, ptr addrspace(5) %"49", align 8
  %16 = load i64, ptr addrspace(5) %"47", align 8
  %17 = load i64, ptr addrspace(5) %"49", align 8
  %"71" = inttoptr i64 %16 to ptr addrspace(1)
  store i64 %17, ptr addrspace(1) %"71", align 8
  ret void
}
