...
define amdgpu_kernel void @shfl_sync_bfly_dynamic_delta_b32_pred(ptr addrspace(4) byref(i64) %"67") #1 {
...
"65":                                             ; preds = %1
  ...
  %"131" = call <2 x i32> @__zluda_ptx_impl_shfl_sync_bfly_b32_pred(i32 %7, i32 %8, i32 31, i32 -1)
...
"21":                                             ; preds = %"20", %"65"
  ...
  %"139" = call <2 x i32> @__zluda_ptx_impl_shfl_sync_bfly_b32_pred(i32 %14, i32 %15, i32 31, i32 -1)
...
"23":                                             ; preds = %"22", %"21"
  ...
  %"141" = call <2 x i32> @__zluda_ptx_impl_shfl_sync_bfly_b32_pred(i32 %21, i32 %22, i32 31, i32 -1)
