declare hidden i32 @__zluda_ptx_impl_dp2a_hi_s32_s32(i32, i32, i32) #0

define amdgpu_kernel void @dp2a(ptr addrspace(4) byref(i64) %"46", ptr addrspace(4) byref(i64) %"47") #1 {
...
"45":                                             ; preds = %1
  ...
  %"71" = call i32 @__zluda_ptx_impl_dp2a_hi_s32_s32(i32 %10, i32 %11, i32 %12)
  store i32 %"71", ptr addrspace(5) %"53", align 4
  %13 = load i64, ptr addrspace(5) %"49", align 8
  %14 = load i32, ptr addrspace(5) %"53", align 4
  %"75" = inttoptr i64 %13 to ptr
