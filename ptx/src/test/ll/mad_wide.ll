define amdgpu_kernel void @mad_wide(ptr addrspace(4) byref(i64) %"46", ptr addrspace(4) byref(i64) %"47") #0 {
...
"45":                                             ; preds = %1
  ...
  %9 = load i64, ptr %"44", align 8
  store i64 %9, ptr addrspace(5) %"53", align 8
  ...
  %16 = load i64, ptr addrspace(5) %"49", align 8
  %17 = load i64, ptr addrspace(5) %"50", align 8
  %"71" = inttoptr i64 %16 to ptr
  store i64 %17, ptr %"71", align 8
  ret void
}
